...
//		dictionary.Add("additional_param", "value");
//
...
////		y += GuiTapTargetHeight;
////		
////		if (GUI.Button(new Rect (x, y, GuiRectWidth, GuiTapTargetHeight), pauseDownloadsString))
////		{
////			pauseDownloads = !pauseDownloads;
////			pauseDownloadsString = pauseDownloads ? "Resume Video Downloads" : "Pause Video Downloads";
////			sponsorPayPlugin.VideoDownloadPause(pauseDownloads);
////		}
////
////		
////		y += GuiTapTargetHeight + GuiRectBigPadding;
...
//		if (GUI.Button(new Rect (x, y, GuiRectWidth, GuiTapTargetHeight), "Show Ad Video")) 
//		{
//			requestMBEOffers();
//		}
//		
